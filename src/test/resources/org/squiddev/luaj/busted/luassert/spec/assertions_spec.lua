describe("Test Assertions", function()
	...
	pending("tests the error outputted for same() with multiple arguments, to report the failing value - format not implemented", function()
	...
	pending("Checks has_error compares error objects - tostring doesn't work", function()
	...
	pending("Checks register creates custom assertions - NYI", function()
